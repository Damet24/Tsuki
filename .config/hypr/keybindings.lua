...
hl.bind("SUPER + SHIFT + F", function()
	os.execute("hyprctl clients -j | jq -r '.[].address' | xargs -I {} hyprctl dispatch setfloating {}")
end)
...
-- Focus with SUPER + N/I/U/E (Colemak arrow keys)
...
-- Resize with SUPER + SHIFT + N/I/U/E
